...
import (
	...
	"github.com/smallnest/rpcx/v6/tool/xgen/parser"
)
...
func generate(parsers []*parser.Parser) error {
	...
	fmt.Fprintln(w, `  "github.com/smallnest/rpcx/v6/server"`)
	fmt.Fprintln(w, `  "github.com/smallnest/rpcx/v6/serverplugin"`)
