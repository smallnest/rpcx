...
func (o *ColfArgs) MarshalLen() (int, error) {
	...
	if l > ColferSizeMax {
		return l, ColferMax(fmt.Sprintf("colfer: struct codec.ColfArgs exceeds %d bytes", ColferSizeMax))
	}
	return l, nil
}
...
func (o *ColfArgs) Unmarshal(data []byte) (int, error) {
	if len(data) > ColferSizeMax {
		...
		if err == io.EOF {
			return 0, ColferMax(fmt.Sprintf("colfer: struct codec.ColfArgs exceeds %d bytes", ColferSizeMax))
		}
		return n, err
	}
...
func (o *ColfReply) MarshalLen() (int, error) {
	...
	if l > ColferSizeMax {
		return l, ColferMax(fmt.Sprintf("colfer: struct codec.ColfReply exceeds %d bytes", ColferSizeMax))
	}
	return l, nil
}
...
func (o *ColfReply) Unmarshal(data []byte) (int, error) {
	if len(data) > ColferSizeMax {
		n, err := o.Unmarshal(data[:ColferSizeMax])
		if err == io.EOF {
			return 0, ColferMax(fmt.Sprintf("colfer: struct codec.ColfReply exceeds %d bytes", ColferSizeMax))
		}
		return n, err
	}
